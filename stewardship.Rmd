...
![](images/DirtyDishes.JPG){.custom_wide .grow .shadow}

Always make sure to clean your dishes after a project. When you are planning an experiment, good lab stewardship means you've planned time to do the dishes too. Running out of time before classes or having conducted a time-consumiming project is not an acceptable reason for not cleaning up after yourself. Leaving dirty dishes in the sink prevents other people from being able to use it. 
...
![](images/ImproperPlateStorage.jpg){.custom_image .grow .shadow}
...
![](images/RiskyStorage.jpg){.custom_image .grow .shadow}


Always store your items in a safe way that keeps things organized and prevents accidents. Storing items precariously means they can be easily knocked over, possibly destroying the contents, contaminating storage containers, and creating a mess.  For example, in the photo at the right, there were no labels on these tubes, which means no one except the owner knows whether they contain some toxic or hazardous substance. Although this may be the "quick and easy" way to store some items, it does not follow the lab safety protocols and could be dangerious to your lab mates. Always plan in time to keep your items organized, labeled, and stowed properly. 
...
![](images/UnorganizedFreezer.jpg){.custom_image .shadow .grow}
...
![](images/BiohazardBinFull.JPG){.custom_image .shadow .grow}
...
![](images/AutoclaveYourTrash.jpg){.custom_image .shadow .grow}
