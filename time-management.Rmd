...
### What's the secret?
Effective time management and prioritization is the secret.  If you are already working 40-50 hours per week, you should not beat yourself up to work more hours (quantity), you should re-evaluate how you are spending your time (quality).  Focus on improving the quality of the hours you already work.  
...
3. Prioritize using value of time + value of work
4. Eliminate potential pitfalls 
5. Finalize your priority list
...
### Pitfalls
Some of the items listed above were both low pay-off and low effort (bold).  Other items are low-pay off and high effort (numbers 9 to 13).  Both of these categories represent time traps and pitfalls that should be avoided. Low effort tasks do not take much effort, so it is easy to spend time here.  However, due to the low pay-off from these activities, you should minimize the amount of time spent on these activities.  Likewise, items listed as low pay-off and high effort are definitely not worth much of your time on a daily basis.  Make sure to eliminate these items and focus only on the most important priority list.  
