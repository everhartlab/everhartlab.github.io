...
In the steps below, I explain how you can create a priority list for your daily and long-term tasks using the following steps:
1. Value your work, 
2. Value your time, 
...
### Pitfalls
Some of the items listed above were both low pay-off and low effort (bold).  Other items are low-pay off and high effort (numbers 9 to 13).  Both of these categories represent time sinks and pitfalls that should be avoided. This is because low effort tasks do not take much effort, so it is easy to spend too much time here.  However, due to the low pay-off from these activities, you don't get much in return.  You should minimize the amount of time spent on these activities.  Likewise, items listed as low pay-off and high effort are definitely not worth much of your time on a daily basis.  These will take you a lot of time to complete with very little reward.  Make sure to eliminate these items from your priority list and focus only on the most important tasks.  
